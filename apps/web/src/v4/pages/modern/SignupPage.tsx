...
export function SignupPageModern() {
  const {t, dir} = useI18n();
  ...
  return (
    <div className="v4-auth-split" dir={dir}>
      <section className="v4-auth-hero" aria-hidden="true">
        ...
        <div>
          <h2>{t('auth.signupHeroTitle', {defaultValue: 'Start accepting payments in minutes'})}</h2>
          <p>
            {t('auth.signupHeroBody', {
              defaultValue: 'Create your organization, verify email, and complete onboarding in one flow.',
            })}
          </p>
        </div>
      ...
      <section className="v4-auth-panel">
        <div className="v4-card v4-login-card" style={{maxWidth: 480}}>
          <div className="v4-brand" style={{marginBottom: '1.25rem'}}>
            <div className="v4-brand-mark">IMK</div>
            <div>
              <h1 style={{margin: 0, fontSize: '1.35rem', fontWeight: 800}}>{t('auth.signup')}</h1>
