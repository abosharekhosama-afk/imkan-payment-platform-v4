...
- Name: role-matrix.spec.ts >> Phase 6.6 merchant role matrix >> MERCHANT_ADMIN — nav + forbidden + create hidden + API deny
...
- textbox "Email": e2e-merchant_admin@example.test
- text: Password
