...
- Name: security\role-matrix-security.spec.ts >> P15.0 security e2e >> MERCHANT_VIEWER — roles deep-link denied + mutate APIs forbidden
- Location: e2e\security\role-matrix-security.spec.ts:13:3
...
```yaml
- heading "Merchant onboarding" [level=2]
- paragraph: Complete legal, business, people, and documents, then submit KYB to enter the console.
- text: Status
- strong: DRAFT
- text: Requirements
- strong: 1/6 (17%)
- text: Missing
- strong: "5"
- text: "Onboarding is incomplete. Missing: KYB_BUSINESS_PROFILE_REQUIRED, KYB_DOC_COMPANY_REGISTRATION, KYB_LEGAL_PROFILE_REQUIRED, KYB_MIN_PERSONS, KYB_REGISTERED_ADDRESS_REQUIRED Fill each step below, then submit KYB. Bank account is optional for unlocking the console."
- list:
  - listitem:
    - strong: 1. Legal / profile
    - text: Legal name, registration, entity type, registered address
    - link "Open →":
      - /url: /merchant/profile
  - listitem:
    - strong: 2. Business information
    - text: Industry, business type, description
    - link "Open →":
      - /url: /merchant/business
  - listitem:
    - strong: 3. People
    - text: At least one owner, director, or representative
    - link "Open →":
      - /url: /merchant/people
  - listitem:
    - strong: 4. Documents
    - text: Register company registration document
    - link "Open →":
      - /url: /merchant/documents
  - listitem:
    - strong: 5. Bank / settlement (optional)
    - text: Optional for KYB — requires MFA step-up
    - link "Open →":
      - /url: /merchant/bank-accounts
  - listitem:
    - strong: 6. KYB review & submit
    - text: Submit when requirements are satisfied
    - link "Open →":
      - /url: /merchant/kyb
- button "Dashboard locked until KYB submitted" [disabled]
- link "Review KYB":
  - /url: /merchant/kyb
  - button "Review KYB"
